...
// event listener for toggling menu visibility on button click
if (navToggle) {
...
// event listener for closing menu on button click
if (navClose) {
...
// event listener for accordion header clicks
accordionItems.forEach((item) => {
  ...
  accordionHeader.addEventListener('click', () => {
    ...
    // close open item if another one is clicked
...
// function to check and activate product based on URL parameters
...
// iterate over URL parameters and activate corresponding products
